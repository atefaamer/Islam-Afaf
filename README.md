...
>
> الصور الأصلية (بحجمها الكبير) اتنقلت لفولدر `originals/` في جذر المشروع — مش بتترفع مع الموقع، بس محفوظة عندك. اللي في `public/photos/` نسخ مضغوطة عشان الموقع يفتح بسرعة.
